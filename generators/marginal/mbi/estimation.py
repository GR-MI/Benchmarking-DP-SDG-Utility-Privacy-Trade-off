...
import numpy as np
import sys
sys.path.append('generators\marginal')
from mbi.marginal_loss import LinearMeasurement
from mbi.marginal_oracles import variable_elimination
from mbi.domain1 import Domain
from mbi import domain1, CliqueVector, Factor
...
class GraphicalModel:
    ...
    def synthetic_data(self, rows: Union[int, None] = None):
...
def mirror_descent(
    ...
    known_total: Union[float, None] = None,
    potentials: Union[CliqueVector, None] = None,
...
def interior_gradient(
    domain: Domain,
    loss_fn: Union[marginal_loss.MarginalLossFn, list[LinearMeasurement]],
    lipschitz: Union[float, None] = None,
    known_total: Union[float, None] = None,
    potentials: Union[CliqueVector, None] = None,
    marginal_oracle=marginal_oracles.message_passing_stable,
    iters: int = 1000,

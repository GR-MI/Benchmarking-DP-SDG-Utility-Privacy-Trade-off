...
class Domain:
    ...
    def project(self, attributes: Union[str, Sequence[str]], log: bool = False) -> "Domain":
    ...
    def invert(self, attrs: Sequence[str]) -> Sequence[str]:
    ...
    def size(self, attributes: Optional[Sequence[str]] = None) -> int:

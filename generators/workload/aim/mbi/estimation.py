...
class GraphicalModel:
    ...
    def synthetic_data(self, rows: Optional[int] = None):
...
def mirror_descent(
    ...
    potentials: Optional[CliqueVector] = None,
...
def lbfgs(
    ...
    potentials by back-propagating through the marginal inference oracle.
    ...
    for instance with noisy marginals, the loss function is typically convex with
